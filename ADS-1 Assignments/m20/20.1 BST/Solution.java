    ...
    public static void main(final String[] args) {
        ...
        while (scan.hasNext()) {
            ...
            case "put":
                ...
                bstobj.put(book, tokens[2 + 2]);
                break;
            case "get":
                book = new Book(tokens[1], tokens[2],
                                Float.parseFloat(tokens[2 + 1]));
                System.out.println(bstobj.get(book));
                break;
            case "max":
            ...
            case "floor":
                book = new Book(tokens[1], tokens[2],
                                Float.parseFloat(tokens[2 + 1]));
                System.out.println(bstobj.floor(book));
                break;
            case "ceiling":
                book = new Book(tokens[1], tokens[2],
                                Float.parseFloat(tokens[2 + 1]));
                System.out.println(bstobj.ceiling(book));
                break;
            case "delete":
                book = new Book(tokens[1], tokens[2],
                                Float.parseFloat(tokens[2 + 1]));
